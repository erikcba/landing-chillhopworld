                ...
                <div className='flex flex-col items-center justify-center lg:w-full sm:w-1/2 sm:p-0 w-full px-10 '>
                    <div className='w-full flex flex-col items-center justify-center gap-4 z-10'>
                        ...
                        <div className='w-full'>
                            <a href='https://open.spotify.com/playlist/4eWBwGl0c5wtp6k5Krp6My?si=LYvlJIfzS9uIOyxtSC1RjA' target='_blank' rel='noreferrer' className='bg-fuchsia-600 py-2 px-3 flex flex-row w-fit items-center gap-2 rounded-md text-white font-medium text-lg hover:bg-fuchsia-900 transition-colors ease-in-out duration-500'>
