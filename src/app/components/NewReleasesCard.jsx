...
const NewReleasesCard = ({title, artist, image, id, link}) => {
  return (
    <a key={id} href={link} target='_blank' rel='noreferrer' className='flex flex-col items-center gap-3 lg:mx-4 group hover:cursor-pointer'>
